...
public class GeneratorManager {
    ...
    public void generate(int attendeeStartID, int conferenceDaysStartID, int conferenceReservationStartID, int workshopStartID, int seatsInReservation, int workshopReservationStartID) {
